    ...
    <div id="main" class="w1200">
        ...
        <div class="main_right fr">
            <div class="right_title">
                政策法规
                <div class="weizhi">您当前的位置：<a href="index.php">首页</a>&nbsp;&gt;&nbsp;<a href="regulations.php ">政策法规</a></div>
            </div>
            <div class="right_box">
            <?
            ...
            ?>
                <div class="news_tit">
                    <h2><?=$newsObj->TITLE?></h2>
                    <p>
                        <b>点击量:&nbsp;</b><span style="color: red;"><?=$newsObj->HITS?></span>
                        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                        <b>发布时间:&nbsp;</b><span>[<?echo date("Y.m.d",strtotime($newsList->NOTETIME));?>]</span>
                    </p>
                </div>
                <div class="news_body">
                    <?=$newsObj->CONTENT?>
